turtles-own [food-eaten ant-luck]
...
to go
  ...
  ask turtles 
  [
    ifelse coin-flip? [right random max-turn-angle set color blue set ant-luck ant-luck + 1 ]
    [left random max-turn-angle set color red]  ; if coin-flip? is true, turn right else turn left
  ...
  if  ant-luck = 1 [set ant-luck ant-luck + 1]]
...
276
ant6 luck
(list [coin-flip? ] of turtle 6  [ant-luck] of turtle 6 )\n  \n    ; returns true or false at random
17
1
11
...
1163
470
ants-luck-distribuition
time
ants-luck- in the population
0.0
100.0
0.0
10.0
...
"" ""
PENS
"right" 1.0 0 -15390905 true "" "if ticks > 2 [plot   \n(count turtles with [color = blue] / count turtles ) * 100]"
"left" 1.0 0 -2674135 true "" "if ticks > 10 [plot  (count turtles with [color = red] / count turtles ) * 100]"
